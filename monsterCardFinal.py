...
This program allows the user to search for, add,
delete and print monster cards.
...
# Dictionary to store the details of monster
# cards added during the current session
session_creatures = {}


# Function to display the menu
def display_menu():
    option = easygui.buttonbox("What would you like to do?", "Main Menu",
                               choices=["Search", "Add", "Delete", "Print"])
...
def search_creature():
    while True:
        creature_name = easygui.enterbox(
            "Enter the name of the creature you want to search for:", "Search")
        # Return to the main menu if the user clicks cancel
        ...
        if creature_name in creatures or creature_name in session_creatures:
            creature_stats = creatures.get(creature_name) \
                             or session_creatures.get(creature_name)
            ...
            while True:
                ...
                if choice == "Return to Main Menu":  # Return to the main menu
                    ...
                    # Get the new value for the stat
...
def add_creature():
    while True:
        creature_name = easygui.enterbox(
            "Enter the name of the creature you want to add:", "Add Creature")
        ...
        creature_stats = {  # Get the stats of the creature
            "Strength": easygui.integerbox(
                "Enter the strength of the creature:", "Add", lowerbound=1,
                upperbound=25),
            "Speed": easygui.integerbox("Enter the speed of the creature:",
                                        "Add", lowerbound=1, upperbound=25),
            "Stealth": easygui.integerbox("Enter the stealth of the creature:",
                                          "Add", lowerbound=1, upperbound=25),
            "Cunning": easygui.integerbox("Enter the cunning of the creature:",
                                          "Add", lowerbound=1, upperbound=25)
        }
        # Add the creature to the session dictionary
...
def delete_creature():
    while True:
        creature_name = easygui.enterbox(
            "Enter the name of the creature you want to delete:",
            "Delete Creature")
        ...
        if creature_name in creatures:  # If the creature is in the dictionary
            ...
            easygui.msgbox(
                f"{creature_name} has been deleted from the current session.")
            # Confirmation message
        elif creature_name in session_creatures:
            # If the creature is in the session
...
def print_menu():
    easygui.msgbox("Press 'ok' to print the list of creatures to console.",
                   "Print Creatures")
    menu = "Menu:"
    # Print creatures from the dictionary
    for creature, stats in creatures.items():
        # For each creature in the dictionary
    ...
    for creature, stats in session_creatures.items():
        # For each creature in the session
        menu += f"{creature}: Strength={stats['Strength']}, " \
                f"Speed={stats['Speed']}, " \
                f"Stealth={stats['Stealth']}, " \
                f"Cunning={stats['Cunning']}\n"
